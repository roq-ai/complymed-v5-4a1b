...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'task.create': {
    roles: ['franchise-user', 'organization-user'],
    key: 'task-created',
    tenantPath: ['client', 'organization', 'franchise', 'task'],
    userPath: [],
  },
  'task.delete': {
    roles: ['franchise-user', 'organization-user'],
  ...
  'task.update': {
    roles: ['super-admin', 'organization-user'],
    key: 'task-completed',
    tenantPath: ['client', 'organization', 'franchise', 'task'],
    userPath: [],
  },
...
const ownerRoles: string[] = ['organization-user'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['franchise-user', 'organization-user'];
