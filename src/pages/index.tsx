...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`complyMed v5`}</title>

        <meta
          name="description"
          content="Experience streamlined compliance management with complyMed v5 - your gateway to efficient task tracking, clear organizational hierarchy, and transparent franchise operations. Empower your users, optimize your tasks, and enhance your operations."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience streamlined compliance management with complyMed v5 - your gateway to efficient task tracking, clear organizational hierarchy, and transparent franchise operations. Empower your users, optimize your tasks, and enhance your operations.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Organization User" type="organization-user" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
