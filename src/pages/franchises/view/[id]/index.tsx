...
import { getFranchiseById } from 'apiSdk/franchises';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('franchise', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/franchises/edit/${id}`} passHref legacyBehavior>
                    <Button
